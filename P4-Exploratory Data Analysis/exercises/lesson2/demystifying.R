...
#close the scope within the with. any changes here do not affect outside variables
with(statesInfo,{
...
#with replacement -> repeat rows/observations
#without replacement -> each row can only appear once
